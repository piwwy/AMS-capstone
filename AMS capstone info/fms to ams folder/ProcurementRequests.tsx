...
const ProcurementRequests: React.FC<ProcurementRequestsProps> = ({ user }) => {
    ...
    setRequests([
      {
        ...
        amount: 15000.00,
        description: 'New computers and office equipment',
        justification: 'Current equipment is outdated and affecting productivity',
        priority: 'high',
        status: 'pending',
        approved_by_name: '',
        approved_at: '',
      ...
      },
      {
        ...
        justification: 'Annual maintenance contract renewal required',
        priority: 'medium',
        status: 'approved',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Procurement & Financial Requests</h1>
          <p className="text-gray-600">Centralize purchase requisitions, vendor selection, and PO issuance</p>
        </div>
        <button
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-sm text-gray-600">Centralize purchase requisitions, vendor selection, and PO issuance</p>
          </div>
          <div>
            <h3 className="font-medium text-gray-900 mb-2">Key Processes</h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Request for Quotation (RFQ)</li>
              <li>• Vendor comparison & award</li>
              <li>• PO creation & distribution</li>
              <li>• Contract tracking</li>
            </ul>
          </div>
          <div>
            <h3 className="font-medium text-gray-900 mb-2">Integrations</h3>
            <p className="text-sm text-gray-600">Feeds AP and Asset modules; impacts encumbrances in Budget</p>
          </div>
        </div>
      </div>
